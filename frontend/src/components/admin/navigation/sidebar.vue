  ...
  <div class="bg-[#34699A] w-screen h-screen flex">
    ...
    >
      ...
      <div class="flex flex-col mt-6 gap-2 tracking-wide text-[12px] w-full">
        ...
        <!-- !Graphs Section  -->
        <div v-if="isExpanded" class="text-md text-white text-left">Graphs</div>
        <div v-for="item in reportItems" :key="item.name" class="w-full">
        ...
        <!-- !  Price & Supplies Section  -->
        <div v-if="isExpanded" class="text-md text-white text-left">
          Price & Supplies
        </div>
        <div v-for="item in inventoryItems" :key="item.name" class="w-full">
          <!-- Non-children router-link -->
          <router-link
            v-if="!item.children"
            :to="item.route"
        ...
        <!-- !Accounts Section  -->
        <div v-if="isExpanded" class="text-md text-white text-left">Users</div>
        <div v-for="item in accountItems" :key="item.name" class="w-full">
          <!-- Non-children router-link -->
          <router-link
            v-if="!item.children"
            :to="item.route"
